            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="d-flex justify-content-between align-items-center">
                        {{-- Teks di kiri --}}
                        <h5 class="fw-bold mb-0">Edit Informasi</h5>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- Form untuk edit information --}}
                        <form method="POST" action="{{ route('informations.update', $information->id) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="description" rows="3">{{ old('description', $information->description) }}</textarea>
                            </div>
                                ...
                                @if ($information->file_path)
                                    <div class="mb-3">
                                        ...
                                        <div class="p-2 border rounded d-inline-block text-center" style="min-width: 200px;">
                                            <a href="{{ asset('storage/' . $information->file_path) }}" target="_blank" class="text-decoration-none text-dark">
